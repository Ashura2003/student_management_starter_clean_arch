...
import 'package:student_management_starter/features/courses/data/data_source/local/course_local_datasource.dart';
...
class CourseLocalRepository implements ICourseRepository {
  ...
  Future<Either<Failure, bool>> deleteCourse(String courseId) {
    return courseLocalDataSource.deleteCourse(courseId);
  }
}
